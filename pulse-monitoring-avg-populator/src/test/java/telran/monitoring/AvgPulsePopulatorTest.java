...
class AvgPulsePopulatorTest {
	...
	private static final long PATIENT_ID_1 = 123;
	private static final long PATIENT_ID_2 = 124;
	...
	PulseProbe pulseProbe1 = new PulseProbe(PATIENT_ID_1, 0, 0, VALUE1);
	PulseProbe pulseProbe2 = new PulseProbe(PATIENT_ID_2, 0, 0, VALUE2);
